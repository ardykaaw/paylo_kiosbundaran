    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetHeader className="sr-only">
          <SheetTitle>Bilah Sisi</SheetTitle>
          <SheetDescription>Menampilkan bilah sisi mobile.</SheetDescription>
        </SheetHeader>
        <SheetContent
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      aria-label="Buka/Tutup bilah sisi"
      tabIndex={-1}
      onClick={toggleSidebar}
      title="Buka/Tutup bilah sisi"
      className={cn(
...
function SidebarGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="group"
      className={cn("relative flex w-full min-w-0 flex-col gap-3 p-3", className)}
      {...props}
    />
  )
}
...
function SidebarGroupContent({
  ...
  return (
    <div
      ...
      className={cn("w-full text-base flex flex-col gap-2", className)}
      {...props}
    />
  )
}
