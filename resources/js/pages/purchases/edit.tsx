...
export default function PurchaseEdit() {
    const { props } = usePage();
    const { purchase, branches, suppliers, products } = props as any;
    ...
    return (
        <>
            <Head title={`Edit Purchase ${purchase.number}`} />
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">Edit purchase order {purchase.number}</p>
                    </div>
                </div>
